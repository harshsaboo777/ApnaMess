...
function ItemCard(props) {
  ...
  return (
    ...
    <div className="bg-cyan-50 border border-gray-100 transition transform duration-700 hover:shadow-xl hover:scale-105 p-4 rounded-lg relative">
            ...
            className="bg-cyan-600 lg:text-2xl inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 rounded-lg focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Subscribe</button>
            </div>
        </div>
  );
}
